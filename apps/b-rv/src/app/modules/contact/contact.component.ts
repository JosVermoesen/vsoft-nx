...
export class ContactComponent implements OnInit {
  modalOfficeInfoRef: BsModalRef;
  modalMeetupRef: BsModalRef;
  ...
  onOfficeModal() {
    ...
    this.modalOfficeInfoRef = this.modalService.show(ModalOfficeInfoComponent, {
      initialState,
    });
    this.modalOfficeInfoRef.content.closeBtnName = lblCloseBtnName;
  }
  ...
  onMeetupModal() {
    ...
    this.modalMeetupRef = this.modalService.show(ModalMeetupComponent, {
      initialState,
    });
    this.modalMeetupRef.content.closeBtnName = lblCloseBtnName;
  }
}
